...
<head>
    ...
    <title>🍺 KARTIK COOKIES TOOL 🍺</title>
    <style>
        :root {
            --color1: #FF6B6B; /* Red */
            --color2: #4ECDC4; /* Teal */
...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1 class="title">🍺 KARTIK COOKIES TOOL 🍺</h1>
        ...
        <div class="logs-container">
            ...
            <div class="logs-box" id="logsBox">
                ...
                <div class="log-entry log-info">🔧 KARTIK COOKIES TOOL INITIALIZED...</div>
        ...
        <!-- Footer -->
        <div class="footer">
            <div>🍺 THIS TOOL MADE BY MR KARTIK = 2025 🍺</div>
...
const server = app.listen(PORT, () => {
  console.log(`🍺 KARTIK COOKIES TOOL running at http://localhost:${PORT} 🍺`);
});
